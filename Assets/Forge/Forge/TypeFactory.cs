...
{
    /// <summary>
    ///     The TypeFactory is responsible for creating and fixing Forge Types.
    ///     It intercepts and edits types to be suitible for the factory to forge the object correctly
    /// </summary>
    public class TypeFactory
    {
        private const string Forge_ASSEMBLY = "DynamicForgeAssembly";
        ...
        protected ModuleBuilder GetModuleBuilder()
        {
            ...
            AssemblyName assemblyName = new AssemblyName(Forge_ASSEMBLY);
