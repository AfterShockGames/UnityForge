...
namespace Forgery.Anvil.Registry
{
    /// <summary>
    ///     Forgery Register class. This is the base class for creating registries.
    ...
    public class Register : MonoBehaviour
    {
        ...
        public static Register InstantiateRegister
        {
            get
            {
                ...
                _register.CreateRegistry(InternalData.FORGERY_REGISTRY);
                _register.CreateRegistry(InternalData.FORGERY_COMPONENT_REGISTRY);
        ...
        public Registry<T> CreateRegistry<T>(string registryName)
        {
            if (_registerList.ContainsKey(registryName))
            {
                throw new ForgeryCritical(Language.ForgeryCriticalRegistryAlreadyExists);
            }
