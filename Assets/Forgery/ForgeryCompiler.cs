...
{
    /// <summary>
    ///     Forgery Compiler helps compiling mods on the fly.
    /// </summary>
    internal class ForgeryCompiler
    {
        ...
        public ForgeryCompiler()
        {
            ...
            _compilerParameters.ReferencedAssemblies.Add(Path.Combine(_assemblies, "Forgery.dll"));
